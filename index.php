...
.bg_home_image{
  background:linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(images/ivory/home.jpg); height: 100%; width: 100%; background-position:center; background-size: 100%;
}
        ...
        <div class="fixed-column1">
            <div class="bg_home_image"></div>
                <div class="work-text-content">
                    <div class="container small-container" style="justify-content: center; margin-top: 5%;">
